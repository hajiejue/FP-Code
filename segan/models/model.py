...
class SEGAN(Model):
    ...
    def train(self, opts, dloader, criterion, l1_init, l1_dec_step,
        ...
        if enhance_cmvn_path:
            ...
            enhance_cmvn = compute_cmvn_epoch(opt, dloder, enhance_model, feat_model)
        ...
        for epoch in range(1, opts.epoch + 1):
            ...
            for bidx, batch in enumerate(dloader, start=1):
                ...
                enhance_feat = feat_model(Genh)
                clean_feat = feat_model(clean)
                enhance_loss = F.l1_loss(enhance_feat, clean_feat)
                enhance_loss = opt.enhance_loss_lambda * enhance_loss
                enhance_feature = feat_model(Genh, fbank_cmvn)
